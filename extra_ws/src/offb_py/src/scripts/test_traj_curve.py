...
if __name__=="__main__":
	bag = rosbag.Bag('/home/yanlong/extra_ws/src/offb_py/src/scripts/report/data_curve_{}.bag'.format(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())), 'w')
	bag2 = rosbag.Bag('/home/yanlong/extra_ws/src/offb_py/src/scripts/report/data2_curve_{}.bag'.format(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())), 'w')
	bag3 = rosbag.Bag('/home/yanlong/extra_ws/src/offb_py/src/scripts/report/data3_curve_{}.bag'.format(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())), 'w')
	bag4 = rosbag.Bag('/home/yanlong/extra_ws/src/offb_py/src/scripts/report/data4_curve_{}.bag'.format(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())), 'w')
	global current_state
	global recordflag
